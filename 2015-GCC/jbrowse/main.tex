...
{
  \usebackgroundtemplate{\includegraphics[height=\paperheight,width=\paperwidth]{snapshot10.png}}
...
{
  \usebackgroundtemplate{\includegraphics[height=\paperheight,width=\paperwidth]{snapshot11.png}}
  \setbeamertemplate{navigation symbols}{}
  \begin{frame}[plain]
  \end{frame}
}
