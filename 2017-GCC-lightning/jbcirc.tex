...
{%
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{unsorted.png}}
  \setbeamertemplate{navigation symbols}{}
  \begin{frame}[plain]
  \end{frame}
}
...
{%
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{sorted.png}}
  \setbeamertemplate{navigation symbols}{}
  \begin{frame}[plain]
  \end{frame}
}
...
{%
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{sorted_inv.png}}
  \setbeamertemplate{navigation symbols}{}
  \begin{frame}[plain]
  \end{frame}
}
